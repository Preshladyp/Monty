...
/**
 * pchar_error -if stacks is
 *               empty Prints pchar error messages for empty stacks
 *               and non-character values.
 * @line_number: Line number in Monty bytecodes file if  error occurred.
 * @message: Prints corresponding error message.
 * Return: (EXIT_FAILURE) always.
 */
int pchar_error(unsigned int line_number, char *message)
{
